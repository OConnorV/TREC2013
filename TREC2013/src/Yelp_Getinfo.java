...
public class Yelp_Getinfo {
   ...
   */
  public Yelp_Getinfo(String consumerKey, String consumerSecret, String token, String tokenSecret) {
...
/**
  ...
  // CLI
  public ArrayList ret_info(double lat, double longi, String city) {
    ...
    String response = yelp.search(lat, longi);
   // double lat = 35.9132;
